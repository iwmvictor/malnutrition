  ...
  const features = [
    {
      ...
      description:
        "Advanced algorithms analyze growth patterns and provide personalized nutrition recommendations.",
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Multi-Role Platform",
      description:
        "Designed for parents, health advisors, and administrators across all administrative levels.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Available in English, Kinyarwanda, and French to serve all communities.",
    },
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Our platform combines cutting-edge AI with local healthcare
                expertise to provide comprehensive malnutrition tracking and
                prevention.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <p className="text-gray-400 text-center md:text-right">
                © 2025 Buzima App. Empowering healthier communities through
                technology.
              </p>
            </div>
          </div>
